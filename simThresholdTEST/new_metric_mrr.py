...
def calculate_mrr(simThreshold, result_siamese_csv, df_siamese, df_clones):
    ...
    df_queries2 = df_clones.drop_duplicates(subset=['file1'])
    num_queries2 = df_queries2.shape[0]
    ...
    all_reciprocal_rank = {
        ...
        'status': { 
            ...
            'inside_clones': inside_clones_in_oracle.shape[0],
            'exact_inside_clones': exact_inside_prediciton.shape[0],
    ...
    all_reciprocal_rank['correct_predictions'] = clones_in_oracle[['file1', 'start1', 'end1']].values.tolist()
    all_reciprocal_rank['not_predictions'] = not_predicted_clones.values.tolist()
