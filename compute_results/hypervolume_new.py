...
def plot_hypervolume(ref_point, ref_point_neighbor, all_excel_path):
    algorithms_labels = [
        'Grid Search',
        'Random Search',
    ...
    plt.plot(ref_point[0], ref_point[1], marker='o', markersize=8, label=f'Reference Point 1')
    plt.plot(ref_point_neighbor[0][0], ref_point_neighbor[0][1], marker='o', markersize=8, label=f'Reference Point 2')
    plt.plot(ref_point_neighbor[1][0], ref_point_neighbor[1][1], marker='o', markersize=8, label=f'Reference Point 3')
...
ref_point_neighbor = compute_neighbor_ref_point(all_points, 0.01)
...
plot_hypervolume(ref_point, ref_point_neighbor, all_excel_path)